...
return {
conversation: 'WhatsApp Bot By Yepz'
}}
}
...
let teksnotif = `*YepzGo* Berhasil Tersambung Ke Nomor WhatsApp ${conn.user.id.split(":")[0]}`
conn.sendMessage("628892966443@s.whatsapp.net", {text: teksnotif})
