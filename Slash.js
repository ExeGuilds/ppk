...
console.log(chalk.green.bold("《 ") +
                        chalk.magenta.bold("Console By Haikal") +
                        chalk.green.bold(" 》 ") +
                        chalk.blue(time) +
                        " from " +
...
'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;ttname,;;;\nFN:ttname\nitem1.TEL;waid=628892966443:628892966443\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
sendEphemeral: true
}}
}
...
body: proto.Message.InteractiveMessage.Body.fromObject({
text: "*All TRX Open ✅*\n\n*KALL STORE* *Menyediakan Produk & Jasa Dibawah Ini*"
}),
        ...
        await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: "Powered By Yepz"
                }
            }
        }, { quoted: m });
...
case 'removebg': {
    ...
    try {
        ...
        const imageUrl = await uploadUguu(localFile);
...
case 'sc': {
let url = 'https://github.com/Myyepz'
...
await conn.sendMessage(m.chat, {
        ...
        interactive: [{
            ...
            buttonParamsJson: JSON.stringify({
                business_phone_number: '628892966443'
            })
        }]
    });
}
